...
public class MakeChat {
    ...
    public static void textToSpeech(String text,String language) {
        try {
            ...
            StringEntity stringEntity=new StringEntity(Util.format("{\"data\":[\"{}\",\"神里绫华_ZH\",4,0.2,0.5,0.9,1.3,\"{}\",null],\"event_data\":null,\"fn_index\":2,\"session_hash\":\"{}\"}",text,language,session_hash), StandardCharsets.UTF_8);
